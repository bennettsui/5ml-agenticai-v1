    ...
    <div className="flex flex-col gap-5">
      ...
      {newBadges.length > 0 && (
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl px-4 py-3 flex items-center gap-3">
          ...
          <Link href="/adaptive-learning/learn/badges" className="ml-auto text-xs text-amber-400 underline shrink-0">View</Link>
        </div>
      )}
      ...
      <div className="bg-gradient-to-br from-indigo-600/20 to-purple-600/10 border border-indigo-500/30 rounded-2xl p-5">
        ...
        <Link href="/adaptive-learning/learn/session"
      ...
      <div className="space-y-2">
        {[
          { href: '/adaptive-learning/learn/progress', icon: BarChart3, title: 'My Progress', desc: 'Mastery across all topics' },
          { href: '/adaptive-learning/learn/concepts', icon: BookOpen,  title: 'Browse Concepts', desc: 'All S1–S2 learning objectives' },
          { href: '/adaptive-learning/learn/badges',   icon: Award,     title: 'My Badges', desc: `${stats ? stats.mastered_count : '…'} concepts mastered` },
