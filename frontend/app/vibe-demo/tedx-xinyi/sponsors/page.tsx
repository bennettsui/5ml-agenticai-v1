...
const LOGO_GROUPS = [
  {
    title: 'In-kind Growth Partners',
    titleZh: '大會官方成長夥伴',
    desc: '提供從文具、禮品到體驗設計等資源，陪伴參與者把靈感帶回家。',
    slots: ['Moleskine', 'Partner Name', 'Partner Name', 'Partner Name'],
  },
  {
    title: 'Video & Creative Partners',
    titleZh: '影音與創意夥伴',
    desc: '提供攝影、錄影與視覺創作，讓講者內容在活動後持續被看見。',
    slots: ['Partner Name', 'Partner Name', 'Partner Name', 'Partner Name'],
  },
  {
  ...
  },
  {
    ...
    slots: ['TEDx Partner', 'Community Org', 'Tech Partner', 'Innovation Hub'],
  },
];
  ...
  return (
    <div className="tedx-xinyi bg-white text-neutral-900 min-h-screen">
      ...
      <section className="relative min-h-[52vh] flex items-end bg-neutral-900 overflow-hidden">
        {/* Subtle warm gradient glow on sides */}
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 pb-20 pt-36 w-full">
          ...
          <FadeIn delay={150}>
            <p className="text-white/70 text-base sm:text-lg leading-relaxed max-w-2xl mb-3">
              TEDxXinyi collaborates with partners across industries to bring Ideas Worth Spreading to life in Xinyi, Taipei.
            </p>
            <p className="text-white/40 text-sm" lang="zh-TW">感謝歷屆所有合作夥伴、志工與社群朋友的支持。</p>
          </FadeIn>
        </div>
      </section>
      ...
      <Section bg="white">
        <FadeIn>
          <SectionLabel>Highlighted Partners 精選夥伴</SectionLabel>
      ...
      <Section bg="warm" id="why-partner">
        <FadeIn>
          ...
          <h2 className="text-3xl md:text-4xl font-black mb-2" lang="zh-TW">
            Why Partner with TEDxXinyi
          </h2>
          <p className="text-neutral-500 text-lg font-light mb-12" lang="zh-TW">為何與 TEDxXinyi 合作</p>
        </FadeIn>
          ...
          {[
            {
              ...
              en: 'Brand with ideas',
              zh: '與好點子站在一起',
              bodyEn: 'Align your brand with Ideas Worth Spreading and a global TEDx community that values curiosity, creativity, and impact.',
              bodyZh: '把品牌與「好點子、創造力與社會影響力」連結在一起，走進以故事與內容為核心的國際社群。',
            },
            {
              icon: '🔗',
              en: 'Engage an idea-driven community',
              zh: '接觸行動派社群',
              bodyEn: 'Reach participants who care about the future, innovation, and meaningful conversations — ideal for brand experiences and product trials.',
              bodyZh: '參與者關心未來、創新與議題，是最適合品牌體驗與產品試用的一群人。',
            },
            {
              icon: '🌱',
              en: 'Create lasting impact',
              zh: '讓影響力延續活動之外',
              bodyEn: 'Talks and stories from TEDxXinyi continue to live online, in media, and in communities long after the event night.',
              bodyZh: '講者故事與內容在活動後，會持續透過影片、社群與媒體被看見與分享。',
            },
          ].map((card) => (
            <FadeIn key={card.zh}>
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-neutral-100 hover:shadow-md hover:-translate-y-1 transition-all duration-200 h-full">
                ...
                <h3 className="text-lg font-black mb-1">{card.en}</h3>
                <p className="text-sm font-semibold text-neutral-400 mb-4" lang="zh-TW">{card.zh}</p>
                <p className="text-sm text-neutral-500 leading-relaxed mb-2">{card.bodyEn}</p>
                <p className="text-xs text-neutral-400 leading-relaxed" lang="zh-TW">{card.bodyZh}</p>
              </div>
            </FadeIn>
          ))}
        </div>
      ...
      <Section bg="white" id="strategic-partners">
        <FadeIn>
          ...
          <h2 className="text-3xl md:text-4xl font-black mb-2">Strategic Impact Partners</h2>
          <p className="text-neutral-400 text-lg font-light mb-3" lang="zh-TW">策略影響夥伴</p>
          <p className="text-neutral-500 text-sm leading-relaxed max-w-xl mb-12" lang="zh-TW">
            These partners go beyond one-time support and work with TEDxXinyi on long-term conversations and experiments for the city.<br />
            <span className="text-neutral-400">這些夥伴不只提供資源，而是與 TEDxXinyi 一起為城市策劃長期對話與實驗。</span>
          </p>
        </FadeIn>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-16">
          {[
            { tag: 'Official Growth Partner / 大會官方成長夥伴', name: 'Moleskine', desc: 'Creativity, craft, and the tools that carry ideas forward.' },
            { tag: 'Impact Partner / 影響力夥伴', name: 'Taiwan Fund for Children and Families', nameZh: '家扶基金會', desc: 'A long-term partner building meaningful community connections.' },
          ].map((card) => (
            <FadeIn key={card.name}>
              <div className="border border-neutral-100 rounded-2xl p-6 hover:shadow-md hover:-translate-y-1 transition-all duration-200">
                ...
                <p className="font-black text-base">{card.name}</p>
                {'nameZh' in card && <p className="text-sm text-neutral-400 mb-1" lang="zh-TW">{card.nameZh}</p>}
                <p className="text-sm text-neutral-500 mt-1">{card.desc}</p>
              </div>
            </FadeIn>
          ))}
        </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] gap-8 items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-600 leading-relaxed mb-2">
                    Together with iKala, TEDxXinyi explores how AI can enhance event experiences, content curation, and community engagement.
                  </p>
                  <p className="text-xs text-neutral-400 leading-relaxed mb-4" lang="zh-TW">
                    與 iKala 合作，TEDxXinyi 正在探索如何運用 AI 強化活動體驗、內容策展與社群經營，讓每一位參與者的影響力被科技放大。
                  </p>
                  <ul className="space-y-2">
                    {['AI tools integrated into communication and event workflows', 'Co-creating content and insights with data and community feedback'].map((b) => (
                      <li key={b} className="flex gap-2 text-sm text-neutral-500">
      ...
      <Section bg="warm" id="sponsorship-plans">
        <FadeIn>
          ...
          <h2 className="text-3xl md:text-4xl font-black mb-2">Sponsorship Plans</h2>
          <p className="text-neutral-400 text-lg font-light mb-4" lang="zh-TW">贊助方案</p>
          <p className="text-neutral-500 text-sm leading-relaxed max-w-xl mb-12" lang="zh-TW">
          ...
          {PLAN_CARDS.map((plan) => (
            <FadeIn key={plan.tier}>
              ...
              >
                ...
                <p className="text-xl font-black leading-tight mb-1" lang="zh-TW">{plan.name}</p>
      ...
      <Section bg="white" id="community-partners">
        <FadeIn>
          ...
          <h2 className="text-3xl md:text-4xl font-black mb-2">In-kind &amp; Community Partners</h2>
          <p className="text-neutral-400 text-lg font-light mb-14" lang="zh-TW">實物與社群夥伴</p>
        </FadeIn>
          ...
          {LOGO_GROUPS.map((group) => (
            <FadeIn key={group.title}>
              <h3 className="text-base font-black mb-1">
                {group.title}{' '}
                <span className="font-light text-neutral-400" lang="zh-TW">{group.titleZh}</span>
              </h3>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {group.slots.map((name, i) => (
                  <div key={i}>
                    <LogoSlot label="Logo" />
                    <p className="text-xs text-neutral-400 text-center font-semibold tracking-wide mt-2">{name}</p>
                  </div>
                ))}
              </div>
            </FadeIn>
      ...
      <Section bg="red" id="contact">
        <div className="max-w-xl mx-auto text-center">
          <FadeIn>
            ...
            <h2 className="text-3xl md:text-4xl font-black mb-2">Partner with TEDxXinyi</h2>
            <p className="text-white/70 text-lg font-light mb-8" lang="zh-TW">與 TEDxXinyi 合作</p>
          </FadeIn>
          <FadeIn delay={100}>
