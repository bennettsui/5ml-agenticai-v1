...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://5ml-agenticai-v1.fly.dev/tedx-xinyi/hero-home.jpg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://5ml-agenticai-v1.fly.dev/tedx-xinyi/hero-home.jpg'],
  },
  alternates: {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: 'TEDxXinyi',
            url: 'https://5ml-agenticai-v1.fly.dev/vibe-demo/tedx-xinyi',
            logo: 'https://5ml-agenticai-v1.fly.dev/tedx-xinyi/hero-home.jpg',
            description:
