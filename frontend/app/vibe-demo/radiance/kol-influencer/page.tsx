  ...
  return (
    <main className="bg-white text-gray-900">
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-8">Why KOL & Influencer Marketing Matters</h2>
          ...
          <ul className="space-y-4">
            <li className="flex gap-4">
              ...
              <span className="text-gray-700"><strong>Trust & Authenticity:</strong> Audiences trust influencer recommendations over brand advertising, making influencer partnerships highly credible and effective.</span>
            </li>
            <li className="flex gap-4">
              <span className="text-blue-600 font-bold text-xl">●</span>
              <span className="text-gray-700"><strong>Targeted Reach:</strong> Influencers allow you to reach specific audience segments (niche interests, demographics, values) where your customers congregate.</span>
            </li>
            <li className="flex gap-4">
              <span className="text-blue-600 font-bold text-xl">●</span>
              <span className="text-gray-700"><strong>Content Generation:</strong> Influencer partnerships produce authentic content assets (posts, stories, videos) that you can repurpose across your own channels.</span>
            </li>
            <li className="flex gap-4">
              <span className="text-blue-600 font-bold text-xl">●</span>
              <span className="text-gray-700"><strong>Performance-Based ROI:</strong> Unlike some marketing channels, influencer partnerships can be structured around specific KPIs—clicks, sign-ups, purchases.</span>
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-12">Our Approach to KOL & Influencer Marketing</h2>
          ...
          <div className="space-y-12">
            <div>
              <h3 className="text-xl font-bold mb-3">Strategic Influencer Identification</h3>
            ...
            <div>
              <h3 className="text-xl font-bold mb-3">Partnership Negotiation & Contract Management</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3">Campaign Strategy & Creative Guidance</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3">Performance Tracking & Optimization</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3">Relationship Management & Retention</h3>
              <p className="text-gray-700 leading-relaxed">
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-10">
            <div>
              <h3 className="text-xl font-bold mb-4 text-blue-600">Influencer Identification & Vetting</h3>
              <ul className="space-y-2 ml-4">
                <li className="text-gray-700">• Influencer landscape research and category mapping</li>
                <li className="text-gray-700">• Audience demographic and engagement analysis (using social tools)</li>
                <li className="text-gray-700">• Content alignment assessment and partnership fit evaluation</li>
                <li className="text-gray-700">• Curated influencer recommendations across tiers (macro, mid, micro)</li>
                <li className="text-gray-700">• Audience authenticity and fraud detection analysis</li>
              </ul>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-4 text-blue-600">Campaign Strategy & Planning</h3>
              <ul className="space-y-2 ml-4">
                <li className="text-gray-700">• KOL / influencer campaign objectives and KPI definition</li>
                <li className="text-gray-700">• Content brief development and campaign guidelines</li>
                <li className="text-gray-700">• Campaign timeline and sequencing strategy</li>
                <li className="text-gray-700">• Influencer mix and budget allocation optimization</li>
                <li className="text-gray-700">• Integration with PR, events, and social campaigns</li>
              </ul>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-4 text-blue-600">Partnership Management & Negotiation</h3>
              <ul className="space-y-2 ml-4">
                <li className="text-gray-700">• Influencer outreach and relationship building</li>
                <li className="text-gray-700">• Rate negotiation and partnership term discussion</li>
                <li className="text-gray-700">• Contract drafting and deliverable specification</li>
                <li className="text-gray-700">• Payment processing and compliance management</li>
                <li className="text-gray-700">• Multi-campaign and ambassador program arrangements</li>
              </ul>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-4 text-blue-600">Campaign Execution & Coordination</h3>
              <ul className="space-y-2 ml-4">
                <li className="text-gray-700">• Creator briefing and content approval process</li>
                <li className="text-gray-700">• Product seeding and sample provision (if applicable)</li>
                <li className="text-gray-700">• Content draft review and feedback coordination</li>
                <li className="text-gray-700">• Publishing timing coordination and promotion planning</li>
                <li className="text-gray-700">• Real-time engagement support during campaign period</li>
              </ul>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-4 text-blue-600">Performance Measurement & Reporting</h3>
              <ul className="space-y-2 ml-4">
                <li className="text-gray-700">• Real-time content monitoring and engagement tracking</li>
                <li className="text-gray-700">• Campaign performance reporting (reach, engagement, sentiment, conversion)</li>
                <li className="text-gray-700">• ROI analysis and cost-per-outcome calculation</li>
                <li className="text-gray-700">• Creator performance benchmarking and recommendations</li>
                <li className="text-gray-700">• Content repurposing guidance for your owned channels</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="border border-gray-200 rounded-lg p-8 bg-white">
              <h3 className="text-xl font-bold mb-4 text-blue-600">Beauty & Wellness Brand Building Creator Network</h3>
              ...
              <div className="border-l-4 border-blue-600 pl-4">
                <p className="text-gray-700 italic">
                  <strong className="text-blue-600">Result:</strong> 2.5M combined reach across influencer posts; 8% average engagement rate (3x industry benchmark); 15% of engaged audience visited brand website; brand achieved 25K Instagram followers in first 6 months, largely driven by influencer audience conversion.
                </p>
              </div>
            </div>

            <div className="border border-gray-200 rounded-lg p-8 bg-white">
              <h3 className="text-xl font-bold mb-4 text-blue-600">Tech Startup Launching with KOL Credibility Strategy</h3>
              <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              <div className="border-l-4 border-blue-600 pl-4">
                <p className="text-gray-700 italic">
                  <strong className="text-blue-600">Result:</strong> 5 influencer posts generated 750K combined impressions; 12% average click-through rate to product demo; 300+ educator sign-ups attributed to influencer traffic; partnership generated 6 media mentions as journalists picked up influencer enthusiasm.
                </p>
              </div>
            </div>

            <div className="border border-gray-200 rounded-lg p-8 bg-white">
              <h3 className="text-xl font-bold mb-4 text-blue-600">Sustainability NGO Building Advocate Community</h3>
              <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              <div className="border-l-4 border-blue-600 pl-4">
                <p className="text-gray-700 italic">
                  <strong className="text-blue-600">Result:</strong> 10 ambassadors created 40+ posts over 6 months; 1.8M reach with 6% engagement rate; campaign site generated 5K sign-ups from influencer traffic; ambassador program has now expanded to 25 creators with ongoing collaboration.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg p-8 border border-gray-200">
              ...
              <h3 className="text-2xl font-bold mb-3">Strategy & Influencer Identification</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white rounded-lg p-8 border border-gray-200">
              ...
              <h3 className="text-2xl font-bold mb-3">Partnership Negotiation & Planning</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white rounded-lg p-8 border border-gray-200">
              ...
              <h3 className="text-2xl font-bold mb-3">Campaign Execution & Monitoring</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white rounded-lg p-8 border border-gray-200">
              ...
              <h3 className="text-2xl font-bold mb-3">Analysis & Future Strategy</h3>
              <p className="text-gray-700 leading-relaxed">
      ...
      <section id="contact" className="py-20 px-6 bg-blue-600 text-white">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to Amplify Through Influencer Partnerships?</h2>
