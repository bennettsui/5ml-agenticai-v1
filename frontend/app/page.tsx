...
import {
  Layers, ArrowRight, LayoutDashboard, Sparkles, TrendingUp, Brain, DollarSign,
  ChevronRight,
} from 'lucide-react';
import {
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 pb-20">
        ...
        <section className="mb-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { value: `${totalAgents}+`, label: 'Agents', sub: 'Marketing, Finance, Intel', accent: 'border-t-purple-500', color: 'text-purple-400' },
              ...
              { value: '7', label: 'Infrastructure Layers', sub: 'All active & running', accent: 'border-t-emerald-500', color: 'text-emerald-400' },
            ].map((stat) => (
