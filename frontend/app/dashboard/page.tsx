...
type Tab = 'control' | 'overview' | 'architecture' | 'analytics' | 'scheduling' | 'knowledge' | 'costs' | 'workflows' | 'chat' | 'security' | 'sme-growth' | 'pdf-compression';
...
export default function Dashboard() {
  const getInitialTab = (): Tab => {
    ...
    const valid: Tab[] = ['control','overview','architecture','analytics','scheduling','knowledge','costs','workflows','chat','security','sme-growth','image-compression','pdf-compression'];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800">
      ...
      <main className={activeTab === 'workflows' ? '' : 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6'}>
        ...
        {activeTab === 'pdf-compression' && <PdfCompression />}
