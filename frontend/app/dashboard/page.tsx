...
import {
  ...
  ExternalLink, Key, Globe, Settings, Copy, CheckCircle2, Link2,
} from 'lucide-react';
...
type Tab = 'control' | 'overview' | 'architecture' | 'analytics' | 'scheduling' | 'knowledge' | 'costs' | 'workflows' | 'chat' | 'security' | 'adaptive' | 'links';
...
export default function Dashboard() {
  const getInitialTab = (): Tab => {
    ...
    const valid: Tab[] = ['control','overview','architecture','analytics','scheduling','knowledge','costs','workflows','chat','security','adaptive','links'];
