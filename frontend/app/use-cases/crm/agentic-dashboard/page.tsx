  ...
  const features = [
    {
      ...
      description: 'Full CRM with brands, contacts, contracts, opportunities, and project tracking',
      details: ['Brand profiles with industry & region', 'Contact management with decision power tracking', 'Contract lifecycle management', 'Opportunity pipeline with stage tracking'],
    ...
    },
    {
      ...
      description: 'Log brand feedback and let AI analyze sentiment, extract requirements, and suggest rules',
    ...
    },
    {
      ...
      description: 'Brand-specific rules that evolve into cross-brand patterns and best practices',
      details: ['Brand-specific rules engine', 'Cross-brand pattern detection', 'Global/segment/brand scoping', 'Full-text knowledge search'],
      href: '/use-cases/crm/feedback',
    },
    {
      icon: TrendingUp,
      title: 'Health Score Tracking',
      description: 'Automatic brand health scoring based on feedback, issues, and engagement',
