...
export default function ClientsPage() {
  ...
  const fetchClients = useCallback(async () => {
    ...
    setError(null);
    try {
      const data: PaginatedResponse<Client> = await crmApi.clients.list({
        page,
        size: 20,
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {loading && (
          <div className="flex items-center justify-center py-20">
            ...
            <span className="ml-3 text-slate-400 text-sm">Loading clients...</span>
          </div>
        )}
                  ...
                  {clients.map((client) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-slate-300">
                        {client.industry?.join(', ') || <span className="text-slate-500">--</span>}
                      </td>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-slate-300 text-xs">{client.health_score}</span>
                        </div>
                      </td>
                      <td className="px-6 py-4">
