...
const navItems = [
  ...
  { label: 'ROAS Model', href: '/use-cases/growth-architect/roas', icon: BarChart3 },
  { label: 'Performance', href: '/use-cases/growth-architect/performance', icon: BarChart2 },
  { label: 'Recommendations', href: '/use-cases/growth-architect/recommendations', icon: Lightbulb },
];

export default function GrowthArchitectLayout({ children }: { children: React.ReactNode }) {
  const pathname = usePathname();

  function isActive(href: string) {
    if (href === '/use-cases/growth-architect') {
