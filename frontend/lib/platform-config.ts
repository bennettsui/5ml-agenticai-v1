...
export const USE_CASES: UseCaseConfig[] = [
  ...
  },
  {
    id: 'eventflow',
    name: 'EventFlow',
    description: 'End-to-end event management platform: create events with ticketing tiers, QR-code check-in, real-time attendee tracking, organizer dashboard, and dev admin panel.',
    solutionLine: 'FrontierVentures',
    status: 'live',
    progress: 1.0,
    priority: 'high',
    path: '/eventflow',
    agentCount: 0,
    features: ['Event Ticketing', 'QR Check-in', 'Real-time Sync', 'Organizer Dashboard', 'Dev Admin Panel', 'Multi-tier Pricing'],
  },
  {
