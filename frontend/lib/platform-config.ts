...
export const USE_CASES: UseCaseConfig[] = [
  ...
  },
  {
    ...
    description: 'Multi-language ASR analysis pipeline: Whisper v3 / Google STT → clean transcript, meeting minutes, summaries, and action items. Primary support for Cantonese, also handles Mandarin and English.',
    solutionLine: 'ExpLab',
    status: 'in_progress',
    progress: 0.6,
    priority: 'medium',
    path: '/use-cases/transcription',
    agentCount: 4,
  ...
  {
    id: '3d-printing',
    name: '3D Print Finance',
    description: 'Full-stack financial management platform for 3D printing operations: job costing, overhead allocation, inventory tracking, revenue analytics, scenario modelling, and P&L reporting',
    solutionLine: 'FrontierVentures',
    status: 'in_progress',
    progress: 0.70,
    priority: 'high',
    ...
    features: [
      ...
      'Overhead Allocation Engine (hours-based)',
      'Cost Tracking (variable / fixed / overhead)',
      'CSV & XLSX Cost Upload',
      'Revenue by Channel & Period',
      'Inventory (materials stock)',
      'Scenario Modelling (break-even & margin)',
      'Charts (cost breakdown, channel revenue)',
      'Excel Exports (3 reports)',
      'Job P&L Summary',
    ],
  },
  {
  ...
  },
  {
    ...
    description: 'Full-featured event platform with custom RSVP forms, QR check-in, organizer dashboard, AI content tools, wishlist board, and real-time attendee tracking. → EventFlow',
    solutionLine: 'FrontierVentures',
    status: 'live',
    progress: 1.0,
    priority: 'high',
    path: '/eventflow',
    agentCount: 5,
    features: ['Custom RSVP Forms', 'QR Check-in', 'AI Studio', 'Wishlist Board', 'Organizer Dashboard', 'Real-time Stats'],
  },
  {
    id: 'link-shortener',
    name: 'Link Shortener',
  ...
  },
  {
    id: 'eventflow',
    name: 'EventFlow',
    description: 'End-to-end event management platform with custom RSVP forms, AI content studio (5 tools), QR check-in kiosk, real-time attendee tracking, wishlist board, and multi-tier ticketing.',
    solutionLine: 'FrontierVentures',
    status: 'live',
    progress: 1.0,
    priority: 'high',
    path: '/eventflow',
    agentCount: 5,
    features: ['Custom RSVP Forms', 'AI Studio', 'QR Check-in', 'Wishlist Board', 'Organizer Dashboard', 'Multi-tier Ticketing'],
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      'StudentUxAgent (welcome · feedback · UX copy)',
...
export const ROADMAP_ITEMS: RoadmapItem[] = [
  ...
  },
  {
    ...
    type: 'product',
    owner: 'FrontierVentures Team',
    notes: 'v1 live: job costing, overhead allocation, inventory, revenue channels, scenario modelling, Excel exports, P&L reporting',
  },
  {
