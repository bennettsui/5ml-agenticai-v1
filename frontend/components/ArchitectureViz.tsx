...
const layers: Layer[] = [
  ...
  },
  {
    ...
    components: ['Task Scheduler', 'Retry Logic', 'Workflow Engine'],
    status: 'missing',
    icon: Workflow,
    color: 'indigo',
  },
  {
    ...
    components: ['templates/ directory', 'Task Templates', 'Workflow Patterns'],
    status: 'active',
    icon: FileText,
    color: 'blue',
  },
  {
    ...
    components: ['Embeddings Service', 'Vector Store', 'Connectors (Notion, Web, PDF)'],
    status: 'missing',
    icon: Database,
    color: 'cyan',
  },
  {
    ...
    components: ['Creative Agent', 'SEO Agent', 'Social Agent', 'Research Agent'],
    status: 'active',
    icon: Users,
    color: 'green',
  },
  {
    ...
    components: ['DeepSeek Service', 'Perplexity Service', 'Model Router'],
    status: 'active',
    icon: Cpu,
    color: 'orange',
  },
