...
const layers: Layer[] = [
  {
    ...
    nameZh: '治理與合規',
    description: 'Audit trails, access control, and compliance monitoring',
    components: ['Access Control', 'Audit Logs', 'Compliance Rules'],
    status: 'missing',
    icon: Shield,
    color: 'purple',
  },
  {
    ...
    nameZh: '編排與工作流',
    description: 'Task scheduling, retry logic, and workflow automation',
    components: ['TopicNewsOrchestrator', 'Multi-topic Scheduler', 'WebSocket Server', 'Health Monitor'],
    status: 'active',
    icon: Workflow,
    color: 'indigo',
  },
  {
    ...
    components: ['SetupTopicWorkflow', 'DailyNewsWorkflow', 'WeeklyDigestWorkflow', 'Task Templates'],
    status: 'active',
    icon: FileText,
    color: 'blue',
  },
  {
    ...
    nameZh: '知識管理',
    description: 'Vector embeddings, semantic search, and knowledge connectors',
    components: ['Notion Connector', 'TopicDatabaseInitializer', 'Topics/Sources/News/Digest DBs'],
    status: 'partial',
    icon: Database,
    color: 'cyan',
  },
  {
    ...
    components: ['Creative Agent', 'SEO Agent', 'Social Agent', 'Research Agent', 'Source Curator', 'News Analyst', 'News Writer'],
    status: 'active',
    icon: Users,
    color: 'green',
  },
  {
    ...
    nameZh: '執行引擎',
    description: 'AI provider integration and execution runtime',
    components: ['DeepSeek Service', 'Perplexity Service', 'Model Router', 'InternalLLM Tool', 'NotionTool', 'MultiSourceScraper', 'ResendEmail'],
    status: 'active',
    icon: Cpu,
    color: 'orange',
  },
  {
    ...
    nameZh: '基礎設施與儲存',
    description: 'Database, APIs, and deployment infrastructure',
    components: ['PostgreSQL', 'Express API', 'Docker/Fly.io'],
    status: 'active',
    icon: HardDrive,
    color: 'red',
  },
